...
$Works = [
  [
        'name' => 'Разработчик',
        'dateStart' => 'Январь 2014',
        'dateEnd' => 'Текущее время',
        'description' => 'Описание работы разработчиком, опят работы, обязанности.',
    ],
    [
        'name' => 'Ведущий',
        'dateStart' => 'Январь 2013',
        'dateEnd' => 'январь 2014',
        'description' => 'Описание работы ведущим, опят работы, обязанности.',
    ],
    [
        'name' => 'Журналист',
        'dateStart' => 'Январь 2008',
        'dateEnd' => 'Январь 2013',
        'description' => 'Описание работы Журналистом, опят работы, обязанности.',
    ],
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <?= $Works[$i]['dateStart'];?> - 
            <>
            <span class="w3-tag w3-teal w3-round"><?= $Works[$i]['dateEnd'];?></span></h6>
